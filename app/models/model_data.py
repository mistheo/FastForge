...
class ModelData(Model):
    ...
    @staticmethod
    def to_public_dict(obj: "ModelData", exclude_fields: Optional[list[str]] = None) -> dict:
        """
    ...
    def __repr__(self) -> str:
        ...
        return f"<{
            self.__class__.__name__}(internal_id={
            self.internal_id}, public_id={
            self.public_id}, is_active={
                self.is_active})>"
